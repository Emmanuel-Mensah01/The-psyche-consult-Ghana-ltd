...
type AdminTab = 'overview' | 'students' | 'applications' | 'documents' | 'opportunities' | 'messages' | 'content';
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const [studentsRes, appsRes, docsRes, countriesRes, univRes, progsRes, intakesRes, msgsRes, testimonialsRes, contentRes] = await Promise.all([
        ...
        supabase.from('student_documents').select('*, user_profiles(full_name, email)').order('created_at', { ascending: false }),
