...
export default function BookingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If the visitor happens to be logged in, link the request to their account.
      const {
        data: { user },
      ...
      const { error: dbError } = await supabase.from('booking_requests').insert({
        ...
        counselor: selectedCounselor || null,
      ...
      if (dbError) {
        ...
        setError('We could not save your booking. Please try again or contact us on WhatsApp.');
        return;
      }
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">Our team will review your request and contact you by phone or email to confirm your appointment.</p>
                  <button
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full disabled:opacity-60 disabled:cursor-not-allowed bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl transition-all transform hover:scale-105 flex items-center justify-center gap-2"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                  ...
                  <p className="text-sm text-gray-600 text-center">
                    By booking, you agree to be contacted about your appointment by phone, email or SMS
                  </p>
                </form>
              )}
            </div>
